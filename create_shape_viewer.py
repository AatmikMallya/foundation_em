...
def generate_test_volumes(n_volumes=3):
    """Generate test volumes with masks"""
    print("Generating test volumes...")
    gen = MembraneGen(generate_masks=True)
    
    volumes = []
    masks = []
    seeds = [42, 123, 456][:n_volumes]
...
def main():
    ...
    volumes, masks, seeds = generate_test_volumes(n_volumes=3)
