...
class TrainingProfiler:
    ...
    def log_epoch_summary(self, epoch):
        ...
        if len(self.data_gen_times) > 0:
            total_data_gen_time = sum(self.data_gen_times)
            summary["profiling/epoch_data_generation_time"] = total_data_gen_time
            summary["profiling/epoch_data_gen_percentage"] = (total_data_gen_time / total_epoch_time * 100) if total_epoch_time > 0 else 0
